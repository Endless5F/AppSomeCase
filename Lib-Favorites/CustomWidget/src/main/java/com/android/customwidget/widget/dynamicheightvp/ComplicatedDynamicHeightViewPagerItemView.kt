package com.android.customwidget.widget.dynamicheightvp
...
class ComplicatedDynamicHeightViewPagerItemView(
    private val context: Context,
    private val init: ImageView.() -> Unit
) : ComplicatedDynamicHeightViewPagerItem {
