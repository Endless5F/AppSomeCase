...
public class WebActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.start).setOnClickListener(v -> WebService.start(WebActivity.this));

        findViewById(R.id.stop).setOnClickListener(v -> WebService.stop(WebActivity.this));

        // TODO 已完成
        findViewById(R.id.getData).setOnClickListener(v -> OkHttpUtils.builder()
                .url(ipEdit.getText().toString() + "files/get")
                .success(response -> Toast.makeText(WebActivity.this, response, Toast.LENGTH_LONG).show()).build().get(true));
...
//                okHttpUtils.stopDownload();
        ...
        // TODO 已完成
        findViewById(R.id.upload).setOnClickListener(v -> uploadRequest());
...
//                    .files(fileList)
                    ...
                    .failure(() -> Toast.makeText(WebActivity.this, "上传失败了...", Toast.LENGTH_SHORT).show())
                    .build().postFile(true);
        } else {
