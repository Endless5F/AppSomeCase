package com.android.core.widget.banner.indicator;
...
public class HiNumIndicator extends FrameLayout implements HiIndicator<FrameLayout> {
    ...
    private void init() {
        mPointLeftRightPadding = DimensionsKt.dip(getContext(),10);
        mPointTopBottomPadding = DimensionsKt.dip(getContext(),10);
    }
