package com.android.core.widget.tab.top;
...
public class HiTabTopLayout extends HorizontalScrollView implements IHiTabLayout<HiTabTop, HiTabTopInfo<?>> {
    ...
    private final List<OnTabSelectedListener<HiTabTopInfo<?>>> tabSelectedChangeListeners = new ArrayList<>();
    ...
    private void autoScroll(HiTabTopInfo nextInfo) {
        ...
        //判断点击了屏幕左侧还是右侧
        if ((loc[0] + tabWith / 2) > DimensionsKt.getScreenWidth(getContext()) / 2) {
