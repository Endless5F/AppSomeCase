package com.android.core.widget.tab.bottom;
...
public class HiTabBottomLayout extends FrameLayout implements IHiTabLayout<HiTabBottom, HiTabBottomInfo<?>> {
    ...
    public void inflateInfo(@NonNull List<HiTabBottomInfo<?>> infoList) {
        ...
        int height = DimensionsKt.dip(getContext(), tabBottomHeight);
        FrameLayout ll = new FrameLayout(getContext());
        int width = DimensionsKt.getScreenWidth(getContext()) / infoList.size();
    ...
    private void addBottomLine() {
        ...
        LayoutParams bottomLineParams =
                new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DimensionsKt.dip(getContext(), bottomLineHeight));
        bottomLineParams.gravity = Gravity.BOTTOM;
        bottomLineParams.bottomMargin = DimensionsKt.dip(getContext(), tabBottomHeight - bottomLineHeight);
    ...
    private void addBackground() {
        ...
        LayoutParams params =
                new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DimensionsKt.dip(getContext(), tabBottomHeight));
        params.gravity = Gravity.BOTTOM;
        addView(view, params);
    ...
    private void fixContentView() {
        ...
        if (targetView != null) {
            targetView.setPadding(0, 0, 0, DimensionsKt.dip(getContext(), tabBottomHeight));
    ...
    public static void clipBottomPadding(ViewGroup targetView) {
        if (targetView != null) {
            targetView.setPadding(0, 0, 0, DimensionsKt.dip(AppGlobals.INSTANCE.get().getBaseContext(), tabBottomHeight));
            targetView.setClipToPadding(false);
        }
    }
}
