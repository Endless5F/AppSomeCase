...
open class HiRequest {
     ...
     * https://api.mock.org/v1/ ---relativeUrl: user/login===>https://api.mock.org/v1/user/login
     *
     * 可能存在别的域名的场景
     * https://api.mock.org/v2/
     * https://api.mock.org/v1/ ---relativeUrl: /v2/user/login===>https://api.mock.org/v2/user/login
     */
