...
class DebugTransform(private val project: Project) : Transform() {

    private var userConfig: DebugExtension? = null
    ...
    private fun initConfig() {
        ...
        if (!project.hasProperty(DEBUG_CONFIG)) {
            return
        }

        userConfig = project.property(DEBUG_CONFIG) as DebugExtension?
    }
    ...
    private fun transformFile(file: File) {
        ...
        if (fileName.endsWith(".class")
            ...
            val visitor = DebugClassVisitor(writer)
